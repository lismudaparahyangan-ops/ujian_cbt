...
$env_base_url = getenv('APP_URL');
if (empty($env_base_url) && getenv('RAILWAY_PUBLIC_DOMAIN')) {
...
$config['sess_save_path'] = rtrim(FCPATH, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . 'cbt_sessions';
